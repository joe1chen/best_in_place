...
BestInPlaceEditor.forms = {
    ...
    "cleditor" : {
        activateForm : function() {
            ...
            var theEditor = this.element.find("textarea").cleditor({width:"100%", height:"100%"});
            this.element.find("a.finish-editing").bind('click', {editor: this}, BestInPlaceEditor.forms.cleditor.blurHandler);

            var iframe = this.element.find("iframe");
            // Set min width and min height
            iframe.css({'min-width':width, 'min-height':height});
            ...
            if (typeof body.resize == 'function') {
                body.resize(function() {
                    iframe.css({'height':$(this).height()+20});
                });
            }
